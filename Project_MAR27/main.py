...
#    return [1]*(N+1)
#    return [1 if(i%2==0) else -1 for i in range(N+1)]
#    return [1 if(i%2==0) else 2 for i in range(N+1)]
#    return [10 if(i%2==0) else -1 for i in range(N+1)]
#    return [i if(i%2==0) else 1 for i in range(N+1)]
